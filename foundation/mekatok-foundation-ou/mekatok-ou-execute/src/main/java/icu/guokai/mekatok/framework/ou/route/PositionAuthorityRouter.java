...
import icu.guokai.mekatok.framework.ou.model.table.RoleAuthority;
...
@RequestMapping(OuModuleInfo.MODULE_ROUTE_URI + "/position-authority")
public class PositionAuthorityRouter extends Router implements SimpleCrudSupport<RoleAuthority> {
}
