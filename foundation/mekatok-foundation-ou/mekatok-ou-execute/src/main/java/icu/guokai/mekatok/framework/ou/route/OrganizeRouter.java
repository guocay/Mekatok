...
import icu.guokai.mekatok.framework.ou.model.table.Organize;
...
@RequestMapping(OuModuleInfo.MODULE_ROUTE_URI + "/organize")
public class OrganizeRouter extends Router implements SimpleCrudSupport<Organize> {
}
